            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class='subtitle'>
                  Last updated <bdt className='question'>June 19, 2021</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: 'rgb(127, 127, 127)' }}>
            <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
              <span data-custom-class='body_text'>
                ...
                <bdt className='question'>Jam Academy</bdt>
              ...
              <span data-custom-class='body_text'>
                ...
                contact us at{' '}
                <bdt className='question'>minhlcgcs18128@fpt.edu.vn</bdt>.
              </span>
            </span>
          </span>
        </div>
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span data-custom-class='body_text'>
                ...
                visit our website{' '}
                <bdt className='question'>https://jam/elearn.ga</bdt> (the "
                                          ...
                                          <span
                                            ...
                                            <span data-custom-class='body_text'>
                                              <span style={{ fontSize: 15 }}>
                                                <a
                                                  data-custom-class='link'
                                                  href='https://app.termly.io/notify/e30b409c-b516-4872-b40f-478babbafea2'
                                                  rel='noopener noreferrer'
                                                  target='_blank'>
                                                  here
                                                </a>
